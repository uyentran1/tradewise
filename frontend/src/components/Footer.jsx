                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="text-slate-300 mb-6 max-w-md leading-relaxed">
                            Professional-grade trading signals and technical analysis platform. 
                            Empowering traders with data-driven insights and institutional-quality research tools.
                        </p>
